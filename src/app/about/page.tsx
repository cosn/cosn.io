            ...
            <ul className="ml-8 list-disc">
              <li>
                ...
                <ul className="ml-4 list-disc">
                  ...
                  <li>
                    ...
                    is tremendously difficult to recover from
                  </li>
                </ul>
              </li>
              <li className="mt-2">
              ...
              <li className="mt-2">
                ...
                <ul className="ml-4 list-disc">
                  ...
                  <li>
                    Everything can move faster, though you should focus on
                    accelerating the things that move the needle
                  </li>
              ...
              <li className="mt-2">
                ...
                <ul className="ml-4 list-disc">
                  ...
                  <li>
                    Scarcity of resources increases focus and leads to better
                    prioritization
                  </li>
                  <li>
                    The failure modes of under-staffing tend to be much less
                    severe than those of over-hiring
                  </li>
                </ul>
              </li>
              <li className="mt-2">
                ...
                <ul className="ml-4 list-disc">
                  ...
                  <li>
                    People tend to over-simplify problems (also people, i.e.
                    "person X is good/bad")
                  </li>
                  <li>In conflict, the truth is somewhere in the middle</li>
                  <li>
                    Few situations are zero-sum, and you should strive to avoid
                    them
                  </li>
                </ul>
              </li>
              <li className="mt-2">
                ...
                <ul className="ml-4 list-disc">
                  ...
                  <li>
                    Being able to read the room can give you a significant
                    advantage, especially in tech
                  </li>
                  <li>
                    Learn to trust your instincts, and constantly fine-tune them
