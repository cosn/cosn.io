...
Departures fall into one of three categories, and while the first one might be the most common, the second one is the one that I would hope we, as an industry, invest more into.
