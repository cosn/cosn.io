...
export const post = {
  ...
  description:
    "According to some recent estimates, about one in four engineers use TDD, a figure that aligns with Google Trends data. Over the past few years, the adoption rate has ranged from 20% to 25%. Based on my recent coding experience, I believe TDD's popularity might decline.",
}
...
In my sophomore year at university, I was introduced to Test-Driven Development (TDD). This approach was mentioned frequently throughout my studies and was encouraged in various classes. In my professional career at Microsoft, I was one of the few engineers in my organization who regularly used TDD. Interestingly, the other was my officemate, Bill. Despite this, I wasn't particularly strict about it.

According to some [recent estimates](https://www.practitest.com/resource-center/blog/unveiling-the-2024-state-of-testing), about one in four engineers use TDD, a figure that aligns with [Google Trends](https://trends.google.com/trends/explore?date=all&geo=US&q=%2Fm%2F01_2_v&hl=en) data. Over the past few years, the adoption rate has ranged from 20% to 25%. **Based on my recent coding experience, I believe TDD's popularity might decline.**

## The rise of LLMs in software engineering

You're likely aware of the increasing use of Large Language Models (LLMs) in software engineering. As a software engineer, you've probably experimented with – if not regularly used – LLMs when writing code, whether through copilots or chat interfaces.
