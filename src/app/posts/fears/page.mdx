...
- **Boundaries**: At twice the age of many first-time founders and with a family to consider, can I find the right balance? Will my tendency to become obsessive about work hinder my ability to be a supportive partner, present father, **_and_** successful founder?
- **The long game**: Startups can fail quickly, but true success often takes a decade or more. Will my passion for the business endure for five, ten or more years? I’ve rarely seen successful founders hand off the reins in less than a decade, and it’s hard to predict my mindset so far into the future.
