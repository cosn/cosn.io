...
//           required
//           className="min-w-0 flex-auto appearance-none rounded-md border border-zinc-900/10 bg-white px-3 py-[calc(--spacing(2)-1px)] shadow-md shadow-zinc-800/5 placeholder:text-zinc-400 focus:border-teal-500 focus:outline-none focus:ring-4 focus:ring-teal-500/10 sm:text-sm dark:border-zinc-700 dark:bg-zinc-700/15 dark:text-zinc-200 dark:placeholder:text-zinc-500 dark:focus:border-teal-400 dark:focus:ring-teal-400/10"
//         />
...
// }
//
// function Job({ job: job }: { job: Job }) {
//   let startLabel =
//     typeof job.start === 'string' ? job.start : job.start.label
//   let startDate =
//     typeof job.start === 'string' ? job.start : job.start.dateTime
//
//   let endLabel = typeof job.end === 'string' ? job.end : job.end.label
//   let endDate = typeof job.end === 'string' ? job.end : job.end.dateTime
//
//   return (
//     <li className="flex gap-4">
//       <div className="relative mt-1 flex h-10 w-10 flex-none items-center justify-center rounded-full shadow-md shadow-zinc-800/5 ring-1 ring-zinc-900/5 dark:border dark:border-zinc-700/50 dark:bg-zinc-800 dark:ring-0">
//         <Image src={job.logo} alt="" className="h-7 w-7" unoptimized />
//       </div>
...
//         {resume.map((job, jobIndex) => (
//           <Job key={jobIndex} job={job} />
//         ))}
//       </ol>
